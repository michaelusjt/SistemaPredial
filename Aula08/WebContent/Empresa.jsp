	...
	<div id="main" class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p>${empresa.horarioDeFuncionamento}</p>
			</div>
				<div class="col-md-6">
				<p>
					<strong>Temperatura do ar condicionado</strong>
				</p>
				<p>${empresa.temperaturaDoArCondicionado}</p>
			</div>
			<div class="col-md-6">
				<p>
					<strong>Horario do ar condicionado</strong>
				</p>
				<p>${empresa.horarioDoArCondicionado}</p>
			</div>
		</div>
		<hr />
